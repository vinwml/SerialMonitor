...
#     NEW ints  : t_us,raw,avg_mcounts,v_adc_uV,v_sensor_uV
# - Computes psi from v_sensor using ABP 10–90% ratiometric transfer (ABPDANT005PGAA5 → 0..5 psi)
...
class SerialPlotApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Serial Plotter — Downsampled Display, Full Logging (with PSI)")
        ...
        self.auto_y_checkbox.setChecked(False)  # default manual; change to True for autorange
    ...
    def update_y_axis(self):
        """Apply manual/auto Y scaling depending on selection."""
    ...
    def parse_line(self, s):
        ...
        if len(parts) >= 5:
            ...
            # Compute psi from v_sensor using ABP 10–90% transfer (ratiometric)
...
if __name__ == '__main__':
    ...
    # For max speed you can disable antialias:
